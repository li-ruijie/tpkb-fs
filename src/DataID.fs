...
/// Interval in seconds for hook health check (0=disabled, 0-300)
[<Literal>]
let hookHealthCheck = "hookHealthCheck"
...
/// Enable Filter Keys (accessibility keyboard repeat override)
[<Literal>]
let filterKeys = "filterKeys"

/// Lock Filter Keys (reapply on startup if system state differs)
[<Literal>]
let fkLock = "fkLock"

/// Filter Keys acceptance delay in ms
[<Literal>]
let fkAcceptanceDelay = "fkAcceptanceDelay"

/// Filter Keys repeat delay in ms
[<Literal>]
let fkRepeatDelay = "fkRepeatDelay"

/// Filter Keys repeat rate in ms
[<Literal>]
let fkRepeatRate = "fkRepeatRate"

/// Filter Keys bounce time in ms
[<Literal>]
let fkBounceTime = "fkBounceTime"

/// Keyboard repeat delay (0-3, Windows SPI_SETKEYBOARDDELAY)
[<Literal>]
let kbRepeatDelay = "kbRepeatDelay"

/// Keyboard repeat speed (0-31, Windows SPI_SETKEYBOARDSPEED)
[<Literal>]
let kbRepeatSpeed = "kbRepeatSpeed"
