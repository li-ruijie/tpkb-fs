/// Keyboard event types and virtual key code mappings.
///
/// Defines the KeyboardEvent discriminated union (KeyDown, KeyUp, NonEvent)
/// for keyboard-based scroll triggers. Provides bidirectional mappings between
/// key names (VK_TAB, VK_NONCONVERT, etc.) and Windows virtual key codes.
///
/// Used when keyboardHook is enabled to allow triggering scroll mode with
/// a keyboard key instead of mouse buttons.
module Keyboard
