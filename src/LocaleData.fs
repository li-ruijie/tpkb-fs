/// Japanese translation data for UI strings.
///
/// Contains a dictionary mapping English menu items, messages, and labels
/// to their Japanese equivalents for localized display.
///
/// The get_ja function looks up translations, returning the original
/// English string if no translation is found (fallback behavior).
///
/// All menu items, dialog messages, and labels that appear in the UI
/// should have corresponding entries here for Japanese localization.
module LocaleData
